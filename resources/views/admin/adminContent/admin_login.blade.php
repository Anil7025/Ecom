...
<head>
		...
		<link rel="stylesheet" href="{{asset('admin/css/bootstrap-responsive.min.cs')}}s" />
    ...
    <body>
        <div id="loginbox">
            ...
            @endif
            <form id="loginform" class="form-vertical" action="{{url('admin_login')}}" method="post">
                @csrf
				 <div class="control-group normal_text"> <h3><img src="{{asset('admin/img/logo.png')}}" alt="Logo" /></h3></div>
